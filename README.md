...
First row had original result 1.000000, but with studied calculate is 1.000666. And last row had no 6th column, but studied math estimates it to be 3.657517.
...
Results:
Result for this row: 0.067880 (Original result: 0.100000)
\<snip\>
Result for this row: 2.744270 (Original result: NEW)

First row had original result 1.000000, but with studied calculate is 0.084545. And last row had no 6th column, but studied math estimates it to be 2.744270.
